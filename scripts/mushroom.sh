...
echo "--- Generate model"
$CMD generate -a cbo -m $DATASET-model.dat --support 5 $DATASET-training.dat
echo "--- Run predictions on file with tau properties"
$CMD predict --data-structure=sparse -m $DATASET-model.dat -o $DATASET-predictions.dat $DATASET-tau.dat
